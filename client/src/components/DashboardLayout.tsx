...
import { LayoutDashboard, Search, History, LogOut, PanelLeft, ShieldCheck, CreditCard, Crown, Settings, UserCircle, Wallet, TrendingUp } from "lucide-react";
...
const mainMenuItems = [
  ...
  { icon: TrendingUp, label: "Margem Consignável", path: "/consulta-margem" },
...
function DashboardLayoutContent({ children, setSidebarWidth }: DashboardLayoutContentProps) {
  ...
  const allItems = [...mainMenuItems, ...accountMenuItems];
      ...
      <div className="relative" ref={sidebarRef}>
        <Sidebar collapsible="icon" className="border-r-0" disableTransition={isResizing}>
          ...
          <SidebarContent className="gap-0 mt-2">
            ...
            <SidebarMenu className="px-2 py-1 space-y-1">
              {!isCollapsed && (
                <p className="text-[11px] font-medium text-sidebar-foreground/50 uppercase tracking-wider px-3 mb-1">
                  Conta
                </p>
              )}
              ...
              {isAdmin && (
                <SidebarMenuItem>
                  <SidebarMenuButton
                    ...
                    className="h-10 transition-all font-normal"
                  >
                    <Crown className={`h-4 w-4 ${location === "/admin" ? "text-primary" : "text-amber-500"}`} />
                    <span>Admin</span>
                  </SidebarMenuButton>
                </SidebarMenuItem>
              )}
          ...
          <SidebarFooter className="p-3">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                <DropdownMenuItem onClick={() => setLocation("/assinatura")} className="cursor-pointer">
